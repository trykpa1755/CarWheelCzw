...
{
    public WheelScript[] wheels; // tutaj beda wszystkie nasze kola
    ...
    public Rigidbody rb;
    public float currentSpeed; // aktualna predkosc
    ...
    public void EngineSound()
    {
        ...
        //okreœlamy ile mocy naszego biegu mamy, jak dojdzie do 100 lub 0 bêdziemy zmieniaæ bieg
        currentGearPerc = Mathf.Lerp(currentGearPerc, targetGearFactor, Time.deltaTime * 5f);
        // wyliczamy obroty silnika oraz na jakiej prêdkoœci zmieniamy bieg
